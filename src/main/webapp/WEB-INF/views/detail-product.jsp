        ...
        <div class="detail-wrapper">
            ...
            <div class="product-container">
                ...
                <div class="product-info">
                    ...
                    <div class="product-rating" style="display: flex; align-items: center; gap: 10px; margin: 10px 0;">
                        <c:choose>
                            <c:when test="${not empty totalReviews && totalReviews > 0}">
                                <c:set var="fullStars" value="${displayStar - (displayStar % 1)}" />
                                <c:set var="hasHalf" value="${(displayStar % 1) >= 0.3 ? 1 : 0}" />
                                <c:set var="emptyStars" value="${5 - fullStars - hasHalf}" />

                                <div class="stars" style="color: #ffb703; display: flex; gap: 2px;">
                                ...
                                <div class="rating-info" style="display: flex; align-items: center; gap: 4px; font-size: 14px;">
                                    <span class="rating-avg" style="font-weight: bold; color: #333;">${displayStar}</span>
                                    <span class="rating-count" style="color: #666;">(${totalReviews} đánh giá)</span>
                                </div>
                            </c:when>

                            <c:otherwise>
                                <div class="stars" style="color: #ccc; display: flex; gap: 2px;">
                                    <i class="fa-regular fa-star"></i>
                                    <i class="fa-regular fa-star"></i>
                                    <i class="fa-regular fa-star"></i>
                                    <i class="fa-regular fa-star"></i>
                                    ...
                                    <c:forEach var="rv" items="${reviews}">
                                        <div class="review-item" data-stars="${rv.rating}">
                                            <div class="review-header">
                                                ...
                                                <span class="review-stars" style="color: #FFD43B;">
                                         <c:forEach begin="1" end="${rv.rating}">
                                            <i class="fa-solid fa-star"></i>
                                        </c:forEach>
                                        <c:if test="${5 - rv.rating > 0}">
                                        ...
                                        <i class="fa-regular fa-star"></i>
                                            ...
                                            <div class="review-comment">
                                                <c:choose>
                                                    <c:when test="${not empty rv.comment && rv.comment.trim() != ''}">
                                                        ${rv.comment}
                                                    </c:when>
                                                </c:choose>
                                            </div>
