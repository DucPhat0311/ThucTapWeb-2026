    ...
    <div class="failed-top-banner">
        ...
        <p class="failed-message">
            <c:choose>
                ...
                <c:otherwise>Đơn hàng của bạn đã được ghi nhận nhưng chưa hoàn tất thanh toán.</c:otherwise>
            </c:choose>
        </p>
        ...
        <div class="failed-left">
            <div class="failed-info-card">
                ...
                <ul class="failed-updates">
                    <li><i class="fa-solid fa-triangle-exclamation"></i> Trạng thái: ${not empty paymentStatusLabel ? paymentStatusLabel : "Thanh toán thất bại"}</li>
                    <li><i class="fa-solid fa-credit-card"></i> Phương thức: ${not empty paymentMethodLabel ? paymentMethodLabel : "VNPay"}</li>
                    <li><i class="fa-solid fa-clock-rotate-left"></i> Bạn có thể thử thanh toán lại hoặc kiểm tra đơn hàng trong tài khoản.</li>
                </ul>
            </div>
            ...
            <div class="failed-actions">
                <c:if test="${not empty order && order.paymentMethods == 'VNPAY' && order.paymentStatuses != 'PAID'}">
