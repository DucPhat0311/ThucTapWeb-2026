...
<%
    request.setAttribute("pageCss", "views/order-success.css");
...
<div class="order-success-wrapper">
    <div class="success-top-banner">
        ...
        <h2>Cảm ơn <b>${order.receiverName}</b>, đơn hàng đã được đặt thành công!</h2>
    ...
    <div class="order-success-content">
        <div class="order-left">
            ...
            <div class="action-buttons">
                 <a href="don-mua" class="btn-secondary">Đơn hàng của tôi</a>
