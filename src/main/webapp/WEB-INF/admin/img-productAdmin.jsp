                                ...
                                <div class="page-header">
                                    <div style="display: flex; align-items: center; gap: 15px;">
                                        <a href="${pageContext.request.contextPath}/productAdmin"
                                            class="back-to-product-btn" title="Quay về quản lý sản phẩm">
                                ...
                                <main id="page">
                                    <section class="page active">
                                        ...
                                        <div class="user-toolbar"
                                            ...
                                            <a href="${pageContext.request.contextPath}/productImgAdmin?productId=${productId}&mode=add"
                                                class="btn-add">
                                                                ...
                                                                <tr>
                                                                    ...
                                                                    <td class="text-center"
                                                                        ...
                                                                        <img src="${aura:resolve(pageContext.request.contextPath, '/img/products', img.imageUrl, 'img/logo.png')}"
                                                                            alt="Product Image" class="table-thumbnail">
                                                                    </td>
                                                                    <td class="text-center">
                                                                        <c:choose>
                                                                            ...
                                                                            <c:otherwise>
                                                                                <span class="stock-badge neutral">
