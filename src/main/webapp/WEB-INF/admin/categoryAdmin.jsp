        ...
        <%@ taglib prefix="fmt" uri="http://java.sun.com/jsp/jstl/fmt" %>
            <%@ taglib uri="http://java.sun.com/jsp/jstl/functions" prefix="fn" %>
                ...
                <body>
                                ...
                                <section id="category" class="page active">
                                    ...
                                    <div class="cards">
                                        <div class="card ${empty currentStatus ? 'active' : ''}"
                                            style="cursor: pointer;" onclick="window.location.href='categoryAdmin'">
                                            Tổng danh mục
                                            <span>${totalCategories}</span>
                                        </div>
                                        <div class="card ${currentStatus == 1 ? 'active' : ''}" style="cursor: pointer;"
                                            onclick="window.location.href='categoryAdmin?status=1'">
                                            Đang hoạt động
                                            <span>${activeCategories}</span>
                                        </div>
                                        <div class="card ${currentStatus == 0 ? 'active' : ''}" style="cursor: pointer;"
                                            onclick="window.location.href='categoryAdmin?status=0'">
                                            Đã khóa
                                        ...
                                        <div class="category-actions-wrap">
                                            <div class="stock-search-wrapper">
                                                <input type="text" id="categorySearchInput"
                                                    onkeyup="filterCategoryTable()" placeholder="Tìm kiếm danh mục..."
                                                    class="stock-search-input">
                                                <i class="fa fa-search stock-search-icon"></i>
                                            </div>
                                            <a href="${pageContext.request.contextPath}/categoryAdmin?mode=add"
                                                class="btn-add">
                                        ...
                                        <table class="user-table">
                                            ...
                                            <tbody>
                                                <c:if test="${empty filteredCategoriesList}">
                                                    <tr>
                                                        <td colspan="6" class="text-center" style="padding: 20px;">Không
                                                            có danh mục nào.</td>
                                                    </tr>
                                                </c:if>
                                                                ...
                                                                <c:when test="${c.parentId == 0}">
                                                                    <tr class="category-parent-row"
                                                                        ...
                                                                        <td class="text-center"><span
                                                                                class="type-chip parent">Danh mục
                                                                                cha</span></td>
                                                                        <td class="text-center" style="color: #bbb;">-
                                                                        </td>
                                                                        <td class="text-center">
                                                                            <span
                                                                                class="status ${c.status == 1 ? 'active' : 'blocked'}">
                                                                                ${c.status == 1 ? 'Đang hoạt động' : 'Đã
                                                                                khóa'}
                                                                            </span>
                                                                        </td>
                                                                        <td class="text-center action-buttons">
                                                                            ...
                                                                            <button
                                                                                class="icon-btn ${c.status == 1 ? 'delete' : 'view'}"
                                                                                ...
                                                                                <i
                                                                                    class="fa fa-${c.status == 1 ? 'lock' : 'unlock'}"></i>
                                                                            </button>
                                                                        </td>
                                                                    </tr>
                                                                </c:when>
                                                                <c:otherwise>
                                                                    <tr class="category-child-row"
                                                                        ...
                                                                        <td class="text-center" style="color: #666;">
                                                                            ${c.id}</td>
                                                                        <td class="category-name-child"
                                                                            style="padding-left: 20px !important;">
                                                                            ${c.name}</td>
                                                                        <td class="text-center"><span
                                                                                class="type-chip child">Danh mục
                                                                                con</span></td>
                                                                        <td class="text-center parent-name"
                                                    ...
                                                    <c:otherwise>
                                                        <c:forEach var="parent" items="${parentCategoriesList}">
                                                            <tr class="category-parent-row"
                                                                ...
                                                                <td class="text-center"><span
                                                                        class="type-chip parent">Danh mục cha</span>
                                                                </td>
                                                                <td class="text-center" style="color: #bbb;">-</td>
                                                                <td class="text-center">
                                                                    <span
                                                                        class="status ${parent.status == 1 ? 'active' : 'blocked'}">
                                                                        ${parent.status == 1 ? 'Đang hoạt động' : 'Đã
                                                                        khóa'}
                                                                    </span>
                                                                </td>
                                                                <td class="text-center action-buttons">
                                                                    ...
                                                                    <button
                                                                        class="icon-btn ${parent.status == 1 ? 'delete' : 'view'}"
                                                                        ...
                                                                        onclick="toggleCategoryStatusFromButton(this)">
                                                                        <i
                                                                            class="fa fa-${parent.status == 1 ? 'lock' : 'unlock'}"></i>
                                                                    </button>
                                                                </td>
                                                            </tr>
                                                            ...
                                                            <c:forEach var="child" items="${childCategoriesList}">
                                                                <c:if test="${child.parentId == parent.id}">
                                                                    <tr class="category-child-row"
                                                                        ...
                                                                        <td class="text-center" style="color: #666;">
                                                                            ${child.id}</td>
                                                                        <td class="category-name-child">${child.name}
                                                                        </td>
                                                                        <td class="text-center"><span
                                                                                class="type-chip child">Danh mục
                                                                                con</span></td>
                                                                        ...
                                                                        <td class="text-center">
                                                                            <span
                                                                                class="status ${child.status == 1 ? 'active' : 'blocked'}">
                                                                                ${child.status == 1 ? 'Đang hoạt động' :
                                                                                'Đã khóa'}
                                                                            </span>
                                                                        </td>
                                                                        <td class="text-center action-buttons">
                                                                            ...
                                                                            <button
                                                                                class="icon-btn ${child.status == 1 ? 'delete' : 'view'}"
                                                                                ...
                                                                                onclick="toggleCategoryStatusFromButton(this)">
                                                                                <i
                                                                                    class="fa fa-${child.status == 1 ? 'lock' : 'unlock'}"></i>
                                                                            </button>
                                                                        </td>
                                                                    </tr>
                                                                </c:if>
                    ...
                    <div class="modal-overlay" id="toggle-status-modal">
                        <div class="modal-content modal-small">
                            ...
                            <div class="modal-footer">
                                ...
                                <button type="button" class="btn-delete" onclick="confirmToggleStatus()">Xác
                                    nhận</button>
                            </div>
                        </div>
                    </div>
                    ...
                    <script
                        src="${pageContext.request.contextPath}/js/admin/adminCategory.js?v=<%= System.currentTimeMillis() %>"></script>
