                            ...
                            <section id="dashboard" class="page active">
                                ...
                                <div class="cards">
                                    ...
                                    <div class="card" style="cursor: pointer; transition: transform 0.2s;"
                                        onmouseover="this.style.transform='translateY(-5px)'"
                                        onmouseout="this.style.transform='translateY(0)'"
                                        title="Nhấn để xem chi tiết doanh thu">
                                        Tổng doanh thu
                                        <span>
                                            <span id="dashboard-total-revenue">
                                    ...
                                    <div class="card" style="cursor: pointer; transition: transform 0.2s;"
                                        onmouseover="this.style.transform='translateY(-5px)'"
                                        onmouseout="this.style.transform='translateY(0)'"
                                        title="Nhấn để xem quản lý sản phẩm">
                                        Sản phẩm
                                    ...
                                    <div class="card" style="cursor: pointer; transition: transform 0.2s;"
                                        onmouseover="this.style.transform='translateY(-5px)'"
                                        onmouseout="this.style.transform='translateY(0)'"
                                        title="Nhấn để xem quản lý người dùng">
                                        Người dùng
                                ...
                                <div class="user-table-wrapper">
                                            ...
                                            <tr>
                                                ...
                                                <td>
                                                    <span class="order-status ${o.orderStatus}">
                                                        <c:choose>
                                                            <c:when test="${o.orderStatus == 'PENDING'}">Chờ xử lý
                                                            </c:when>
                                                            <c:when test="${o.orderStatus == 'SHIPPING'}">Đang giao
                                                            </c:when>
                                                            <c:when test="${o.orderStatus == 'COMPLETED'}">Hoàn thành
                                                            </c:when>
                                                            <c:when test="${o.orderStatus == 'CANCELLED'}">Đã hủy
                                                            </c:when>
                                    ...
                                    <div style="margin-top: 15px; text-align: right;">
                                        <a href="${pageContext.request.contextPath}/orderAdmin"
                                            style="color: #8d5e33; text-decoration: none;">Xem tất cả đơn hàng
                                            &rarr;</a>
                                    </div>
                                </div>
