                                                ...
                                                <form method="post" action="${pageContext.request.contextPath}/roleAdmin" id="permissionForm">
                                                    ...
                                                    <div class="permission-table-wrapper">
                                                        <table class="permission-table">
                                                                        ...
                                                                        <div class="th-content">
                                                                            ...
                                                                            <c:if test="${selectedRole.isSystem == 0}">
                                                                                <label class="check-all-col"
                                                                                    ...
                                                                                    <input type="checkbox"
                                                                                        onchange="toggleColumn('view_list', this.checked)">
                                                                                </label>
                                                                            </c:if>
                                                                        </div>
                                                                    </th>
                                                                        ...
                                                                        <div class="th-content">
                                                                            ...
                                                                            <c:if test="${selectedRole.isSystem == 0}">
                                                                                <label class="check-all-col"
                                                                                    title="Chọn tất cả cột">
                                                                                    <input type="checkbox"
                                                                                        onchange="toggleColumn('view_detail', this.checked)">
                                                                                </label>
                                                                            </c:if>
                                                                        </div>
                                                                    </th>
                                                                        ...
                                                                        <div class="th-content">
                                                                            ...
                                                                            <c:if test="${selectedRole.isSystem == 0}">
                                                                                <label class="check-all-col"
                                                                                    title="Chọn tất cả cột">
                                                                                    <input type="checkbox"
                                                                                        onchange="toggleColumn('add', this.checked)">
                                                                                </label>
                                                                            </c:if>
                                                                        </div>
                                                                    </th>
                                                                        ...
                                                                        <div class="th-content">
                                                                            ...
                                                                            <c:if test="${selectedRole.isSystem == 0}">
                                                                                <label class="check-all-col"
                                                                                    title="Chọn tất cả cột">
                                                                                    <input type="checkbox"
                                                                                        onchange="toggleColumn('edit', this.checked)">
                                                                                </label>
                                                                            </c:if>
                                                                        </div>
                                                                    </th>
                                                                        ...
                                                                        <div class="th-content">
                                                                            ...
                                                                            <c:if test="${selectedRole.isSystem == 0}">
                                                                                <label class="check-all-col"
                                                                                    title="Chọn tất cả cột">
                                                                                    <input type="checkbox"
                                                                                        onchange="toggleColumn('delete', this.checked)">
                                                                                </label>
                                                                            </c:if>
                                                                        </div>
                                                                    </th>
                                                                        ...
                                                                        <div class="th-content">
                                                                            ...
                                                                            <c:if test="${selectedRole.isSystem == 0}">
                                                                                <label class="check-all-col"
                                                                                    title="Chọn tất cả cột">
                                                                                    <input type="checkbox"
                                                                                        onchange="toggleColumn('lock', this.checked)">
                                                                                </label>
                                                                            </c:if>
                                                                        </div>
                                                                    </th>
                                                            ...
                                                            <tbody>
                                                                <c:set var="moduleNames"
                                                                    value="user,category,product,order,return,banner,blog,contact,warehouse,role" />
                                                                    ...
                                                                    <tr>
                                                                        <td class="module-name">
                                                                            <c:forTokens items="${moduleLabels}"
                                                                                ...
                                                                                varStatus="labelIdx">
                                                                                <c:if
                                                                                    test="${labelIdx.index == moduleIdx.index}">
                                                                                    ${label}</c:if>
                                                                            </c:forTokens>
                                                                        </td>
                                                                        <c:forTokens items="${actionNames}" delims=","
                                                                            var="act">
                                                                            <td class="perm-cell">
                                                                                <c:set var="mapKey" value="${moduleName}_${act}" />
                                                                                <c:choose>
                                                                                    <c:when test="${applicableMap[mapKey]}">
                                                                                    ...
                                                                                    <c:otherwise>
                                                                                        <span style="color: #d4c4b0; font-weight: bold;">-</span>
                                                                                    </c:otherwise>
                                                                                </c:choose>
                                                                            </td>
                                                                        </c:forTokens>
                                                                        <c:if test="${selectedRole.isSystem == 0}">
                                                                            <td class="toggle-cell">
                                                                                <label
                                                                                    class="perm-checkbox toggle-row-checkbox">
                                                                                    <input type="checkbox"
                                                                                        onchange="toggleRow('${moduleName}', this.checked)">
                                                                                    <span class="checkmark"></span>
                                                                                </label>
                                                                            </td>
                                                                        </c:if>
                                ...
                                <form method="post" action="${pageContext.request.contextPath}/roleAdmin" id="roleForm">
                                    ...
                                    <div class="modal-actions">
                                        <button type="button" class="btn-secondary"
                                            onclick="closeRoleModal()">Huỷ</button>
                            ...
                            <div id="deleteModal" class="modal-overlay">
                                <div class="modal">
                                    ...
                                    <form method="post" action="${pageContext.request.contextPath}/roleAdmin">
                                        ...
                                        <div class="modal-actions">
                                            <button type="button" class="btn-secondary"
                                                onclick="closeDeleteModal()">Huỷ</button>
