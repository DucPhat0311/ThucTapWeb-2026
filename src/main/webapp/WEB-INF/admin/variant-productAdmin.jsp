    ...
    <section class="content">
        <main id="page">
            <section id="dashboard" class="page active">
                ...
                <div class="cards">
                    <div class="card">Tổng biến thể<span id="dashboard-total-variant">${total}</span></div>
                    <div class="card">Tổng tồn kho<span id="dashboard-total-variant-stock">${totalStock}</span></div>
                    <div class="card">Số size<span id="dashboard-total-variant-size">${totalSize}</span></div>
                    <div class="card">Số màu<span id="dashboard-total-variant-color">${totalColor}</span></div>
                </div>
...
<script src="${pageContext.request.contextPath}/js/admin/adminProductVariant.js"></script>
</body>
