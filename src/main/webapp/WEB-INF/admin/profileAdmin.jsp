                                ...
                                <div class="profile-container">
                                    <div class="profile-left">
                                        <div class="avatar-area">
                                            ...
                                            <form id="avatarForm" action="${pageContext.request.contextPath}/profileAdmin"
                                                ...
                                                <input type="file" id="avatar-upload" name="avatarFile" accept="image/*"
                                                    onchange="
                                                        if(this.files && this.files[0]) {
                                                            document.getElementById('avatar-preview').src = window.URL.createObjectURL(this.files[0]);
                                                            document.getElementById('avatarForm').submit();
                                                        }
                                                    ">
                                            </form>
                                            <button type="button" class="avatar-change-btn" onclick="document.getElementById('avatar-upload').click();">
                                                Đổi ảnh
                                            </button>
                                        </div>
                                    ...
                                    <div class="profile-right">
                                        <div class="info-section">
                                            ...
                                            <form id="profileForm"
                                                action="${pageContext.request.contextPath}/profileAdmin" method="post"
                                                ...
                                                <div class="form-row">
                                                    <div class="form-group">
                                                        ...
                                                        <input type="text" id="username" name="username"
                                                            value="${adminInfo.username}" readonly>
                                                    </div>
                                                    <div class="form-group">
                                                        <label for="fullname">Họ và tên</label>
                                                        <input type="text" id="fullname" name="fullName"
                                                            value="${adminInfo.fullName}" required>
                                                    </div>
                                                </div>
                                                <div class="form-row">
                                                    <div class="form-group">
                                                ...
                                                <div class="form-row">
                                                    ...
                                                    <div class="form-group">
                                                        ...
                                                        <select id="gender" name="gender">
                                                            <option value="Nam" ${adminInfo.gender=='Nam' ? 'selected'
                                                                : '' }>Nam</option>
                                                            <option value="Nữ" ${adminInfo.gender=='Nữ' ? 'selected'
                                                                : '' }>Nữ</option>
                                                            <option value="Khác" ${adminInfo.gender=='Khác' ? 'selected'
                                                                : '' }>Khác</option>
                                                        </select>
                                                    </div>
                                                </div>
                                        ...
                                        <div class="password-section">
                                            <h3>Đổi mật khẩu</h3>
                                            <form action="${pageContext.request.contextPath}/profileAdmin"
                                                method="post">
                                                ...
                                                <div class="form-group password-group">
                                                    ...
                                                    <input type="password" id="current-password" name="currentPassword"
                                                        required>
                                                    <i class="fas fa-eye" id="toggle-current-password"
                                                ...
                                                <div class="form-group password-group">
                                                    ...
                                                    <input type="password" id="new-password" name="newPassword"
                                                        required>
                                                    <i class="fas fa-eye" id="toggle-new-password"
