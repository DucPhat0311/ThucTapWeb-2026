            ...
            <div class="profile-container">
                <div class="profile-left">
                    <div class="avatar-container">
                        <img src="${fn:startsWith(adminInfo.avatarUrl, 'http') ? adminInfo.avatarUrl : pageContext.request.contextPath.concat('/img/avatars/').concat(adminInfo.avatarUrl)}" alt="Avatar" id="avatar-preview">
