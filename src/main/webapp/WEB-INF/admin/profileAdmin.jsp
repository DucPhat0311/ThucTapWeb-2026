                                ...
                                <div class="profile-container">
                                    <div class="profile-left">
                                        <div class="avatar-container">
                                            <img src="${fn:startsWith(adminInfo.avatarUrl, 'http') ? adminInfo.avatarUrl : pageContext.request.contextPath.concat('/img/avatars/').concat(adminInfo.avatarUrl)}"
                                                alt="Avatar" id="avatar-preview">
                                            <input type="file" id="avatar-upload" accept="image/*"
                                                style="display: none;">
                                            <button class="upload-btn"
                                                onclick="document.getElementById('avatar-upload').click();">Chọn
                                                ảnh</button>
                                        </div>
                                                ...
                                                <div class="form-row">
                                                    <div class="form-group">
                                                        ...
                                                        <input type="date" id="birthday" name="birthday"
                                                            value="<fmt:formatDate value=" ${adminInfo.birthday}"
                                                            pattern="yyyy-MM-dd" />">
                                                    </div>
                                                    <div class="form-group">
