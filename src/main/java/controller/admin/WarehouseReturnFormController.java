...
@WebServlet("/admin/warehouseReturnForm")
public class WarehouseReturnFormController extends HttpServlet {
    ...
    protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
        ...
        request.getRequestDispatcher("/WEB-INF/admin/warehouseReturnForm.jsp").forward(request, response);
    }
    ...
    protected void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
        try {
            ...
            int orderId = (orderIdStr != null && !orderIdStr.trim().isEmpty()) ? Integer.parseInt(orderIdStr) : 0;
            
            InventoryReceipt receipt = new InventoryReceipt();
            receipt.setType("RETURN");
            ...
            if (isSuccess) {
                request.getSession().setAttribute("message", "Thêm phiếu hoàn kho thành công!");
            } else {
